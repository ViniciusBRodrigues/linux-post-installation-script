...
echo "+------------------------------------------------------------------+"
sudo zypper -n ar -f http://ftp.gwdg.de/pub/linux/misc/packman/suse/openSUSE_Leap_42.3/ packman
sudo zypper -n ar -f http://opensuse-guide.org/repo/openSUSE_Leap_42.3/ libdvdcss
...
echo "Some packages"                                                                                                                                                                                               
echo "+------------------------------------------------------------------+"                                                                                                                                        
sudo zypper install cmake automake qconf fetchmsttfonts texlive-subfloat nlopt-devel texlive-mdframed texlive-wrapfig zlibrary ghc-zlib zlib-devel libopenssl-devel libssh2-devel libcurl-devel libconfig9 libconfig++9 libconfig-devel gcc-c++ typelib-1_0-GtkVnc-1_0 typelib-1_0-GtkVnc-2_0 libgtk-vnc-1_0-0 libgtk-vnc-2_0-0 gtk-devel libxml2-devel gtk-devel gnome-doc-utils gnome-doc-utils-devel libgexiv2-devel libgps22 gnome-themes gnome-themes-extras VirtualGL VirtualGL-32bit VirtualGL-devel libgcrypt-devel lua51-luajit lua51-luajit-devel gtk-common gnome-common                                                                                                                                
...
echo "JabRef"
wget http://download.opensuse.org/repositories/home:/sebschub/openSUSE_Leap_42.3/noarch/jabref-3.8.1-12.1.noarch.rpm
...
echo "Viking GPS"
wget http://download.opensuse.org/repositories/Application:/Geo/openSUSE_Leap_42.3/x86_64/viking-1.6.2-2.10.x86_64.rpm
...
echo "Brackets"
wget http://download.opensuse.org/repositories/home:/awissu/openSUSE_Leap_42.3/x86_64/brackets-1.8-1.1.x86_64.rpm
sudo zypper install -n brackets-1.8-1.1.x86_64.rpm
sudo rm brackets-1.8-1.1.x86_64.rpm

echo "Qgis"
wget http://download.opensuse.org/repositories/Application:/Geo/openSUSE_Leap_42.3/x86_64/qgis-2.18.4-2.8.x86_64.rpm
